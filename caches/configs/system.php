...
'cookie_pre' => 'BVTfz_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://www.ztcnwy.com/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://www.ztcnwy.com/statics/js/', //CDN JS
'css_path' => 'http://www.ztcnwy.com/statics/css/', //CDN CSS
'img_path' => 'http://www.ztcnwy.com/statics/images/', //CDN img
'app_path' => 'http://www.ztcnwy.com/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => '2uWYsicsA4b0UvoLlXLg', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://www.ztcnwy.com/phpsso_server',	//接口地址
'phpsso_auth_key' => 'M7AoUWbP6hOKawPzlAyY8mFcWY8Sgw2z', //加密密钥
